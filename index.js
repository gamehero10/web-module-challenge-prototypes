...
Car.prototype.drive = function(distance) {
 ...
 if(distance <= driveableMiles) {
  this.odeometer = this.odometer + distance;
...
/* 
  ...
  1. Window Binding - When none of the other rules apply, this will return the window or global object in node or undefined in strict mode. Should never use window binding. 
